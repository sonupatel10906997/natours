...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic29udXBhdGVsMTA5MDY5OTciLCJhIjoiY2t6ZXIyb3Q4MWo5azJva3UzbHAza3JoZCJ9.np0iSIRQ2MwBJHrn5cM1gA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 50
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //add marker in map
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status == 'success') location.reload(true); //true means reload from server not cache
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? 'http://127.0.0.1:3000/api/v1/users/updateMe' : 'http://127.0.0.1:3000/api/v1/users/updateMyPassword'; //console.log('URL: ', url);
...
var stripe = Stripe('pk_test_51KanicSHVkrSSC3253sqO7izMre231O157g8hwRyktAjrMs2jq38Yee565H0qHIt0w3PPEGSpY9QZRPB44gqaW0X009zYKMj0U');
